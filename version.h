...
/* version history:
  ...
  03-May-2006: 1.6b2,3 major improvements to handling corrupt RLE data (thanks Torsten Will)
*/
#define VERSION_STR "1.6b3"
#define VERSION_NUM 1,0x60,beta,3
#define VERS_RSRC \
	VERSION_NUM,\
	verAustralia,\
	VERSION_STR,\
